...
import { HeroSection, ScholarshipBanner, CoursesSection, WhyYETP, MissionVisionSection, TestimonialsSection, PartnersSection, CTASection } from "@/components/yetp/sections";
